...
public final class WindowedInventoryClient {
    ...
    public static void initialize() {
        ...
        jeiWindowKey = KeyMappingHelper.registerKeyMapping(
            new KeyMapping(
        ...
        mouseFocusKey = KeyMappingHelper.registerKeyMapping(
            new KeyMapping(
    ...
    public static boolean isMouseFocusKeyDown(Minecraft minecraft) {
        ...
        if (!KeyMappingHelper.isKeyModifierActive(mouseFocusKey)) {
            return false;
        }
        if (mouseFocusKey.isDefault() && isAltDown(minecraft)) {
            return true;
        }
        InputConstants.Key key = KeyMappingHelper.getBoundKeyOf(mouseFocusKey);
    ...
    public static boolean shouldHideHotbar() {
        ...
        Minecraft minecraft = Minecraft.getInstance();
        return minecraft.gui.screen() instanceof InventoryDesktopScreen screen && screen.hasWindows();
    }
