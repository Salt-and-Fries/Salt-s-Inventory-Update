...
public final class SaltsInventoryConfigScreen extends Screen {
        ...
        this.addButton(
            ...
            () -> {
                if (this.minecraft != null) {
                    this.minecraft.gui.setScreen(new ForceContainersConfigScreen(this));
                }
            }
        );
    ...
    public void onClose() {
        ...
        if (this.minecraft != null) {
            this.minecraft.gui.setScreen(!SaltsInventoryRuntime.isEnabled() && this.previousScreen instanceof InventoryDesktopScreen ? null : this.previousScreen);
        }
    }
