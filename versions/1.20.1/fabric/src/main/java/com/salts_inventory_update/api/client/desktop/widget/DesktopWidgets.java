...
public final class DesktopWidgets {
    ...
    public static final ResourceLocation SEARCH_BAR_TEXTURE = new ResourceLocation("salts_inventory_update", "textures/gui/search_bar.png");
    public static final ResourceLocation SCROLLBAR_BACKGROUND_TEXTURE = new ResourceLocation("salts_inventory_update", "textures/gui/scroll_bar_behind.png");
    ...
    public static void renderDropdown(DesktopRenderContext<?, ?> context, int x, int y, int width, List<Component> labels, List<Component> states, int hoveredIndex) {
        ...
        context.windowNineSlice(new ResourceLocation("salts_inventory_update", "textures/gui/window.png"), x, y, width, height);
