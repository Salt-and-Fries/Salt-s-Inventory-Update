package com.salts_inventory_update.platform.fabric.api.client.keymapping.v1;
...
public final class KeyMappingHelper {
    ...
    public static KeyMapping registerKeyMapping(KeyMapping keyMapping) {
        invokeRegister("net.fabricmc.fabric.api.client.keymapping.v1.KeyMappingHelper", "registerKeyMapping", keyMapping);
        return keyMapping;
    }
